...
- **02/07/2026 — Fase D concluída (inventário, filtros e onboarding).**
  ...
  - **Próximo: Fase E** — acessibilidade e mobile de verdade (teclado na árvore/soquetes, foco visível completo, ARIA no minimapa/orbes, alvos ≥44px, pinch-zoom, bottom-sheets, contraste AA). Fundações pendentes: **F1** (tokens semânticos) e **F3** (galeria de componentes).
